...
btn_about='About'
btn_cancel='Cancel'
btn_toggle_alphabet='Alphabetize'
btn_toggle_block='Blacklist'
btn_toggle_priority='Prioritize'
...
btn_skip='Skip'
btn_symbols='Symbols'
btn_third_parties='Third parties'
...
canceled_by_user='Operation has been canceled by the user.'
...
cleared='Cleared'
clipboard_copy_failure='A clipboard error has occurred. Please copy the following MANUALLY:'
clipboard_failure='A clipboard error has occurred!'
...
copy_failure='Failed to copy "%s" to "%s"!'
copy_failure2='Unable to copy "%s" to iself!'
...
create_object='The object will be created.'
creating_dir='Creating directory "%s"...'
creating_file='Creating file "%s"...'
creating_key='Creating key "%s"...'
creating_symlink='Creating a symbolic link "%s"...'
creating_db='Creating database "%s"...'
cur_date='Date: %s'
...
cur_node='Current node: %s'
cur_page='Current page: %d'
...
entries_deleted='Entries deleted: %d (%d-%d)'
...
file_copy_failure2='Unable to copy the file "%s" to iself!'
...
file_time_change='Changing the time of the file "%s" to %s...'
...
formal_check_finished='Formal check of dictionaries has finished.'
...
function='Function:'
gen='Gen.:	%s'
geometry='Widget geometry: %dx%d+%d+%d'
...
hint_do_no_translate='Do no translate the current selection'
...
hint_save_selection='Save the current selection'
hint_search_article='Find in the current article'
hint_symbols='Paste a special symbol'
hint_toggle_alphabet='Toggle alphabetizing'
hint_toggle_block='Toggle the blacklist'
hint_toggle_priority='Toggle prioritizing'
hint_toggle_view='Toggle the article view mode'
hint_ui_lang='Переключиться на русский'
hint_watch_clipboard='Capture Ctrl-c-c and Ctrl-Ins-Ins'
...
id_full_match='A full match has been found for record # %d!'
id_match='A match has been found for record # %d.'
...
incorrect_line='Dictionary "%s": Incorrect line #%d: "%s"!'
...
invalid_path='The path "%s" is invalid!'
...
launch_failure2='Failed to run "%s"!'
layout_failure='Failed to change the layout!'
left_cell='A cell to the left: #%s: %s'
...
line_no='Line %d: "%s"'
lines_mismatch='Lists have a different number of lines (%d and %d correspondingly)!'
...
long_request='The request is long (%d symbols). Do you really want to send it?'
...
mclient='Multitran Online Client:                            [Build version: %s]'
mes='The message: "%s"'
min_col_limit='The minimum number of columns is %d, however, you set %d!'
missing_config='The following sections and/or keys are missing:'
missing_keys='Missing keys: %d'
missing_sections='Missing sections: %d'
...
most_frequent_pattern='The most frequent pattern: #%d'
...
non_sortable='Dictionary "%s" is marked as non-sortable!'
...
not_file='The object "%s" is not a file!'
not_found='not found!'
...
object_not_found='Object "%s" does not exist!'
ok='[OK]: "%s"'
...
opening_link='Open link: %s'
operation_completed='The operation has taken %f s.'
...
ready='Ready!'
rebuild_object='The object will be rebuilt.'
...
right_cell='A cell to the right: #%s: %s'
...
save_article_as_html='Save the original article as a web-page (*.html)'
...
searching='Searching...'
search_from_end='The end has been reached. Searching from the start.'
search_from_start='The start has been reached. Searching from the end.'
...
shift2pos='Shifting the screen to position %s.'
sing='Singular'
...
tag_fg_failure2='Failed to configure tag "%s" to have the foreground of color "%s"!'
...
text='Text:'
time_error='Set time parameters are incorrect or not supported.'
...
wrong_input3='Wrong input data: "%s"'
